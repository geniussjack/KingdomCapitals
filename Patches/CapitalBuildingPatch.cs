...
{
    /// <summary>
    /// Harmony patches to allow capital settlements to build up to level 5 buildings
    /// and provide doubled bonuses from building effects.
    /// </summary>
    public static class CapitalBuildingPatch
    {
